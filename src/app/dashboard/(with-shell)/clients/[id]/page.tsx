            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 space-y-2 min-w-0">
                <div className="flex w-full items-center gap-3">
                  ...
                  <span
                    className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] ml-auto ${
                      clientData.isLead
                        ? 'border border-amber-200 bg-amber-50 text-amber-700'
                        : 'border border-emerald-200 bg-emerald-50 text-emerald-700'
                    }`}
                  >
                    {clientData.isLead ? 'Lead' : 'Client'}
                  </span>
                </div>
                {subLine && (
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {proposalRows.map((proposal) => (
                    <tr key={proposal.id}>
                      ...
                      <td className="px-4 py-3">
                        <Link
                          href={`/dashboard/proposals-contracts/${proposal.id}`}
                          className="text-sm font-semibold text-brand-primary-700 hover:underline"
                        >
                          View
                        </Link>
