      ...
      <div className="mx-auto max-w-6xl">
        ...
        {invoices.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-brand-primary-200 bg-white/60 p-8 text-center shadow-sm">
            <p className="text-lg font-semibold text-gray-900">No invoices yet</p>
            <p className="mt-2 text-sm text-gray-500">Create an invoice to automatically bill your clients.</p>
            <div className="mt-6">
              <Link
