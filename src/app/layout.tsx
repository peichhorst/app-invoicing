    ...
    <html lang="en" suppressHydrationWarning style={htmlStyle as React.CSSProperties}>
      ...
      >
        ...
        <ScrollToTop />
          ...
          <main className="min-h-screen w-full bg-white bg-gradient-to-r- from-brand-primary-700 via-brand-secondary-700 to-brand-accent-700 px-0 sm:px-0 py-0">
            <div className="mx-auto w-full max-w-7xl px-0 sm:px-8 lg:px-10">{children}</div>
          </main>
        </MobileSidebarProvider>
      </body>
    </html>
