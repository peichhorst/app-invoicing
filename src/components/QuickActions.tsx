...
export function QuickActions() {
  ...
  return (
    <div className="flex h-full flex-col justify-center rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] text-[var(--foreground)] px-3 py-3 shadow-sm">
      ...
      <div className="flex flex-col gap-1">
        <button
          ...
          className="flex items-center gap-2 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] px-2 py-1.5 text-[0.65rem] font-semibold uppercase tracking-[0.2em] text-[var(--foreground)] transition hover:border-brand-primary-600 hover:text-brand-primary-700"
        >
